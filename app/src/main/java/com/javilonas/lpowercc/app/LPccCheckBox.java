...
public class LPccCheckBox extends LPccControl implements OnClickListener{

	protected LPccCheckBox(Activity activityIn) {
		super(activityIn);
	}
...
*/
		...
		//checkBox = (CheckBox) temp.findViewById(R.id.LPccCheckBox);
