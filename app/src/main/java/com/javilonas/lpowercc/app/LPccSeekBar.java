...
public final class LPccSeekBar extends LPccControl implements OnSeekBarChangeListener{

	private static String LOG_TAG = Utils.class.getName();


	protected LPccSeekBar(Activity activityIn) {
		super(activityIn);
	}
	...
	public void createInternal() {
		...
		{
			Log.e(LOG_TAG, "LPccSeekBar createInternal: valueFromScript cannot be converted!");
		}
